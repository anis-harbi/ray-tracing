...
public class Geometry {
	...
	static public void squareToPSAHemisphere(Point2 seed, Vector3 outDir) {
		...
		double x_component = r * Math.cos(phi);
		double y_component = r * Math.sin(phi);
		double z_component = Math.sqrt(1 - r * r);
		outDir.x = x_component;
		outDir.y = y_component;
		outDir.z = z_component;
	}
